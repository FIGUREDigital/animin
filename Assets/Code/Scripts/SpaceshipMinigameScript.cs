...
public class SpaceshipMinigameScript : MonoBehaviour 
{
	...
	public UIButton MoveLeftButtonRef;
	public UIButton MoveRightButtonRef;
	...
	void Update () 
	{
		if(Input.GetKey(KeyCode.A) || (MoveLeftButtonRef.state == UIButtonColor.State.Pressed)) MoveLeft();
		if(Input.GetKey(KeyCode.D) || (MoveRightButtonRef.state == UIButtonColor.State.Pressed)) MoveRight();
