	...
	public static void HandleClick(UIFunctionalityId id, GameObject sender)
	{
		...
		case UIFunctionalityId.OpenCloseMedicine:
		{
			...
			if(id == UIFunctionalityId.OpenCloseFoods) 
			{
				...
				UIGlobalVariablesScript.Singleton.PopupIndicator.transform.localPosition = new Vector3(-468, UIGlobalVariablesScript.Singleton.PopupIndicator.transform.localPosition.y, 0);
			}
			else if(id == UIFunctionalityId.OpenCloseMedicine) 
			{
				...
				UIGlobalVariablesScript.Singleton.PopupIndicator.transform.localPosition = new Vector3(156, UIGlobalVariablesScript.Singleton.PopupIndicator.transform.localPosition.y, 0);
			}
