Shader "Chickenlord/Detail/Vertex Colored/Relief Mapping Shaded Specular" {
Properties {
...
SubShader { 
	...
	#pragma surface surf BlinnPhongShifted addshadow vertex:vert
	#pragma target 3.0
	...
	struct SurfaceOutputPS {
	 ...
	 {
	 	data.vertexLighting = v.color.rgb*_VertexMultiplier;
     }
	...
	void surf (Input IN, inout SurfaceOutputPS o) {
		...
		o.Emission += IN.vertexLighting*o.Albedo;
	}
	ENDCG
	}
